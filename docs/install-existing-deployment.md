...
This plugin is `cliproxyapi-cursor` v0.1.0. It invokes only the official Cursor Agent CLI (`agent`) with direct argv. It does not proxy Cursor private endpoints and does not read or store Cursor credentials.
